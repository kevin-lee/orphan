...
private[orphan] object OrphanSprayJson {
  ...
  private[orphan] object SprayJsonJsonWriter {
    ...
    @inline implicit final def getSprayJsonJsonWriter: SprayJsonJsonWriter[spray.json.JsonWriter] =
  ...
  private[orphan] object SprayJsonJsonReader {
    @SuppressWarnings(Array("org.wartremover.warts.Null"))
    @inline implicit final def getSprayJsonJsonReader: SprayJsonJsonReader[spray.json.JsonReader] =
      null // scalafix:ok DisableSyntax.null
  }
  ...
  private[orphan] object SprayJsonJsonFormat {
    @SuppressWarnings(Array("org.wartremover.warts.Null"))
    @inline implicit final def getSprayJsonJsonFormat: SprayJsonJsonFormat[spray.json.JsonFormat] =
      null // scalafix:ok DisableSyntax.null
  }
